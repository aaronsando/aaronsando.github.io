...
<body style="background-color: var(--purple-dark);">
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-2 d-flex align-items-center justify-content-end">
                <button class="btn btn-jedialaa pb-2" data-bs-toggle="modal" data-bs-target="#modalNewProject">
                    Create new project
                </button>
            </div>
        </div>
                ...
                <div class="col-3 mt-4">
                    <a href="{{ url('/project/' . $project->id) }}" class=" text-decoration-none">
                        <div class="card" style="">
                            @if(isset($project->imgDataURL))
                                <img src="{{ $project->imgDataURL }}" class="card-img-top" alt="Miniatura del proyexto">
                            @else
                                <img src="{{ asset('images/default-thumbnail.jpeg') }}" class="card-img-top" alt="Miniatura del proyexto">
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalNewProject" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <form action="/home" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="">
                            ...
                            <input type="text" name="name" id="projname" class="form-control" autocomplete="off"
                                required>
                        </div>
                    </div>
